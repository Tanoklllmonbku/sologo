...
from ..crud.lost_report import (
    create_lost_report, get_user_lost_reports, get_all_lost_reports, 
    update_lost_report_status  # ← изменили с resolve на update
)
from ..crud.user import get_user_by_id
from ..schemas.lost_report import (
    LostReportCreate, LostReportResponse, LostReportStatusUpdate  # ← добавили StatusUpdate
)
from ..models import User, LostStatus
